 ...
 * @author Pathan
 */
public class RotiTawarV1 extends RotiTawar_ToppingFilling{
    //attributes
    int order;

    //roti manis varian 1 membutuhkan filling 5 gram cheese dan 5 gram chocolate
     double filling(){
        return (80 * this.chocolateSum());
    }
    ...
    void Hargatotal(){
        ...
        System.out.println("________________________________________________________________________________");
        System.out.println("Biaya 1 pcs roti manis varian 1 Rp." + harga);
        System.out.println("Biaya untuk " + this.order + " pcs Pesanan Roti manis varian 1 Rp." + harga*this.order);
        System.out.println("--------------------------------------------------------------------------------");
    }
    
    void ButuhBahan(){
        System.out.println("Perkiraan bahan adonan roti tawar varian 1 yang diperlukan :");
        ...
        System.out.println("--------------------------------------------------------------------------------");
        System.out.println("Perkiraan topping dan filling roti tawar Varian 1 yang diperlukan :");
        System.out.println("Coklat : " + 80*this.order + " gr");
        System.out.println("--------------------------------------------------------------------------------");
    }
